<template>
  <div class="w-transfer-panel">
    <p class="w-transfer-panel__header">
      <w-checkbox
        v-model="allChecked"
    ...
    <div :class="['w-transfer-panel__body', hasFooter ? 'is-with-footer' : '']">
      <w-input
        class="w-transfer-panel__filter"
        v-model="query"
        size="small"
        ...
        v-if="filterable">
        <i slot="prefix"
          :class="['w-input__icon', 'w-icon-' + inputIcon]"
          @click="clearQuery"
        ></i>
      </w-input>
      <w-checkbox-group
        ...
        class="w-transfer-panel__list">
        <w-checkbox
          class="w-transfer-panel__item"
          :label="item[keyProp]"
