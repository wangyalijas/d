...
export default {
  ...
  render(h) {
    ...
    const scrollBtn = scrollable
      ? [
        <span class={['w-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="w-icon-arrow-left"></i></span>,
        <span class={['w-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="w-icon-arrow-right"></i></span>
      ] : null;
    ...
    return (
      <div class={['w-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${ this.rootTabs.tabPosition }`]}>
        ...
        <div class={['w-tabs__nav-scroll']} ref="navScroll">
          <div
            class={['w-tabs__nav', `is-${ this.rootTabs.tabPosition }`, stretch && ['top', 'bottom'].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : '']}
            ref="nav"
            style={navStyle}
            role="tablist"
