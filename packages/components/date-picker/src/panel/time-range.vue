    ...
    <div
      ...
      <div class="w-time-range-picker__content">
        <div class="w-time-range-picker__cell">
          <div class="w-time-range-picker__header">{{ t('w.datepicker.startTime') }}</div>
          <div
        ...
        <div class="w-time-range-picker__cell">
          <div class="w-time-range-picker__header">{{ t('w.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="w-time-range-picker__body w-time-panel__content">
            <time-spinner
      ...
      <div class="w-time-panel__footer">
        <button
          ...
          @click="handleCancel()">{{ t('w.datepicker.cancel') }}</button>
        <button
          type="button"
          class="w-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('w.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
