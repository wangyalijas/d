      ...
      <div class="w-picker-panel__body-wrapper">
        ...
        <div class="w-picker-panel__body">
          <div class="w-date-range-picker__time-header" v-if="showTime">
            <span class="w-date-range-picker__editors-wrap">
              <span class="w-date-range-picker__time-picker-wrap">
                <w-input
                  ...
                  ref="minInput"
                  :placeholder="t('w.datepicker.startDate')"
              ...
              <span class="w-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <w-input
                  ...
                  class="w-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('w.datepicker.startTime')"
            ...
            <span class="w-icon-arrow-right"></span>
            <span class="w-date-range-picker__editors-wrap is-right">
              <span class="w-date-range-picker__time-picker-wrap">
                <w-input
                  ...
                  class="w-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('w.datepicker.endDate')"
              ...
              <span class="w-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <w-input
                  ...
                  class="w-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('w.datepicker.endTime')"
          ...
          <div class="w-picker-panel__content w-date-range-picker__content is-left">
            <div class="w-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="w-picker-panel__icon-btn w-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="w-picker-panel__icon-btn w-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="w-picker-panel__icon-btn w-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="w-picker-panel__icon-btn w-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
...
export default {
  ...
  computed: {
    ...
    leftLabel () {
      return this.leftDate.getFullYear() + ' ' + this.t('w.datepicker.year') + ' ' + this.t(`w.datepicker.month${this.leftDate.getMonth() + 1}`)
    },

    rightLabel () {
      return this.rightDate.getFullYear() + ' ' + this.t('w.datepicker.year') + ' ' + this.t(`w.datepicker.month${this.rightDate.getMonth() + 1}`)
    },
