<script>
  ...
  export default {
    ...
    computed: {
      ...
      menuTransitionName() {
        return this.rootMenu.collapse ? 'w-zoom-in-left' : 'w-zoom-in-top';
      },
      opened() {
    ...
    render(h) {
      ...
      const popupMenu = (
        <transition name={menuTransitionName}>
          <div
            ref="menu"
            v-show={opened}
            class={[`w-menu--${mode}`, popperClass]}
            on-mouseenter={this.handleMouseenter}
            on-mouseleave={this.handleMouseleave}
            on-focus={this.handleMouseenter}>
            <ul
              role="menu"
              class={['w-menu w-menu--popup', `w-menu--popup-${currentPlacement}`]}
      ...
      ) ? 'w-icon-arrow-down' : 'w-icon-arrow-right';
      ...
      return (
        ...
        >
          ...
          >
            {$slots.title}
            <i class={[ 'w-submenu__icon-arrow', submenuTitleIcon ]}></i>
          </div>
