  ...
  export default {
    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'w-menu--horizontal': this.mode === 'horizontal',
            'w-menu--collapse': this.collapse,
            "w-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'w-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'w-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'w-menu--collapse')) {
                  removeClass(el, 'w-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'w-menu--collapse');
                } else {
                  addClass(el, 'w-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('WSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
