                  ...
                  this._l(columns, (column, cellIndex) =>
                    <th
                      ...
                      <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                        ...
                        {
                          column.filterable
                            ? <span class="w-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['w-icon-arrow-down', column.filterOpened ? 'w-icon-arrow-up' : ''] }></i></span>
                            : ''
                        }
                      </div>
                    </th>
